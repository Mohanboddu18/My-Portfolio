...
const Index = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      link: "https://drive.google.com/your-aws-cert-link", // Replace with your actual Google Drive link
      isClickable: true
    },
    {
      title: "AICTE , Eduskills Certified Python Developer",
      link: "https://drive.google.com/your-python-cert-link", // Replace with your actual Google Drive link
      isClickable: true
    }
  ];
                ...
                <ul className="space-y-3 text-gray-300">
                  {certifications.map((cert, index) => (
                    <li key={index} className="flex items-start gap-3">
                      ...
                      {cert.isClickable ? (
                        <button
                          onClick={() => openCertificateLink(cert.link)}
                          className="text-left hover:text-purple-300 transition-colors duration-300 cursor-pointer underline decoration-transparent hover:decoration-purple-300 underline-offset-2"
                        >
                          {cert.title}
                        </button>
                      ) : (
